...
2. Click on "Reset Password" link on the login page
3. Enter the admin email (admin@company.com)
4. Check your email for password reset link
5. Follow the link to set a new password

⚠️ **WARNING**: For security reasons, it is strongly recommended to change the default admin password immediately after deploying to production.
