  ...
  login: Trpc.procedurePublic
    ...
    .mutation(async ({ ctx, input }) => {
      try {
        ...
        // Check if user exists and verify admin role first
        if (
          ...
          return {
            success: false,
            redirect: '/login?error=InvalidAdmin',
          }
        }
        ...
        // Set proper redirect based on user role
        const redirectPath = user.globalRole === 'ADMIN' ? '/settings' : '/home'
